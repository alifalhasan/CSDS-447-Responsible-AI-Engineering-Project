...
class StableDiffusionPipeline:
    ...
    def __init__(self, output_dir: str = "m1_SD_result", device: str = "auto"):
        ...
        self.device = device
        self.model_name = "stable-diffusion-v1-5"  # Fixed to Stable Diffusion v1.5
    ...
    def generate_images(self, prompts_data: list, 
        ...
        logger.info(f"Initializing Stable Diffusion v1.5 image generator")
        self.image_generator = ImageGenerator(
            model_name=self.model_name, 
            device=self.device,
            use_refiner=False  # SD v1.5 doesn't use refiner
        )
    ...
    def generate_report(self, analysis: Dict[str, Any]) -> str:
        ...
        report_lines.append("CSDS 447 - STABLE DIFFUSION v1.5 FAIRNESS ANALYSIS REPORT")
        report_lines.append("=" * 80)
        report_lines.append("")
    ...
    def run_complete_pipeline(self, prompts_file: str, 
        ...
        logger.info("=" * 80)
        logger.info("STABLE DIFFUSION v1.5 FAIRNESS ANALYSIS PIPELINE")
        logger.info("=" * 80)
        logger.info(f"Output directory: {self.output_dir}")
        logger.info(f"Model: {self.model_name}")
        logger.info("=" * 80)
        ...
        try:
            ...
            logger.info("\n[Step 2/6] Generating images with Stable Diffusion v1.5...")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Model 1: Stable Diffusion v1.5 Fairness Analysis Pipeline",
...
Examples:
  ...
  python m1_SD.py --prompts custom_prompts.csv
    ...
    if results['status'] == 'success':
        print("\n" + "="*80)
        print("STABLE DIFFUSION v1.5 ANALYSIS COMPLETED SUCCESSFULLY!")
        print("="*80)
        ...
        print(f"\nSTABLE DIFFUSION ANALYSIS FAILED: {results['error']}")
