...
## 9. Model 2 (Flux, Fairness-Aware Setting) Outputs

The directory `m2_FLUX_fair_result/` mirrors the baseline pipeline but stores
results **after applying our fairness-aware configuration**, such as improved
prompt construction or modified sampling strategy.
...
### 9.2 Result Highlights

Below are concise findings from `m2_FLUX_fair_result/figures` generated by `BiasVisualizer`.

---

#### 9.2.1 Gender Distribution

**Corrected values from figure:**
- **Male: 86.7%**
- **Female: 13.3%**

**Observation:**  
Compared with the real-world 50/50 distribution, the model still significantly overproduces male faces, though gender skew is **reduced** compared with the baseline (95% male).


![Gender Distribution](m2_FLUX_fair_result/figures/gender_distribution.png)


---

#### 9.2.2 Race Distribution

**Corrected model proportions from figure:**
- **White: 47.1%**
- **Black: 14.6%**
- **Indian: 3.6%**
- **East Asian: 18.2%**
...
**Key patterns:**
- White remains the dominant racial group (47.1%).
- East Asian remains overrepresented (18.2%).
- Southeast Asian representation stays at **0%**.
- Latino, Indian, and Middle Eastern groups remain comparatively low but slightly improved vs baseline.


![Race Distribution](m2_FLUX_fair_result/figures/race_distribution.png)


---

#### 9.2.3 Age Distribution
...
- **40–49: 1.4%**
- **50–59: 0.1%**
- All other groups (0–2, 3–9, 10–19, 60–69, 70+): **0%**

**Observation:**
The model is extremely concentrated on **young adults (20–39)** → **~98.5%**  
Children, teens, older adults remain absent.


![Age Distribution](m2_FLUX_fair_result/figures/age_distribution.png)


---

#### 9.2.4 Bias Amplification Across Attributes

**Corrected values from figure:**
- **Race BiasAmp: 0.000**
- **Gender BiasAmp: 0.735**
- **Age BiasAmp: 0.000**

**Interpretation:**  
Gender continues to be the **only attribute** showing notable amplification.  
BiasAmp (Gender) drops from baseline's **0.906 → 0.735**, showing mild improvement.  
Race and age remain near-zero.


![Bias Amplification](m2_FLUX_fair_result/figures/bias_amplification_comparison.png)


---

#### 9.2.5 Intersectional Representation

Top groups extracted from the figure:

1. **White_Male_20–29 — 0.220**
2. **White_Male_30–39 — 0.153**
3. **EastAsian_Male_20–29 — 0.125**
4. **Black_Male_20–29 — 0.108**
5. **White_Female_20–29 — 0.065**
6. **Latino_Male_20–29 — 0.064**
7. **MiddleEastern_Male_20–29 — 0.056**
8. **Indian_Male_20–29 — 0.033**
9. **Black_Male_30–39 — 0.033**
10. **EastAsian_Male_30–39 — 0.030**
11. **MiddleEastern_Male_30–39 — 0.025**
12. **White_Female_30–39 — 0.024**
13. **EastAsian_Female_20–29 — 0.014**
14. **EastAsian_Female_30–39 — 0.012**
15. **White_Male_40–49 — 0.008**
16. **Latino_Female_20–29 — 0.004**
17. **Latino_Male_30–39 — 0.004**
18. **Latino_Female_30–39 — 0.004**
19. **MiddleEastern_Female_30–39 — 0.003**
20. **MiddleEastern_Male_40–49 — 0.003**

**Observation:**  
Representation is still heavily dominated by **young adult males**, especially:
- White_Male  
- EastAsian_Male  
- Black_Male (20–29)

Female groups appear very rarely.


![Intersectional Analysis](m2_FLUX_fair_result/figures/intersectional_analysis.png)


---

#### 9.2.6 Statistical Parity Differences (SPD)

**Values from the heatmap:**
SPD ≈ **−0.058** across nearly all race pairs.

**Observation:**
The fairness-aware pipeline **reduces SPD dramatically**, achieving values near zero (−0.058), indicating **strong balancing of racial exposure rates**.


![Statistical Parity Differences](m2_FLUX_fair_result/figures/statistical_parity_differences.png)


---

#### 9.2.7 Interpretation Summary

- **Bias Concentration**  
  Gender is the only dimension with notable amplification (**BiasAmp ≈ 0.735**), reduced from the baseline's 0.906.

- **Pattern**  
  The model continues to produce **young adult males (20–39)** at extremely high rates.

- **Missing Diversity**  
  - Female faces remain underrepresented (13.3%).  
  - Southeast Asian representation stays at **0%**.  
  - Children, teens, and older adults are nearly absent.
